...
public class AsyncUfsAbsentPathCacheTest {
  ...
  public void testUfsAbsentPathCacheCreateUsesConfiguration() {
    ...
    // 3. Test code: call the public factory method
  ...
  @Test
  public void testUfsAbsentPathCacheCreateWithZeroThreads() {
    // 1. Override configuration to 0 threads
    ...
    // 4. Verify NoopUfsAbsentPathCache is returned
    assertTrue(cache instanceof NoopUfsAbsentPathCache);
  }

  @Test
  public void testUfsAbsentPathCacheCreateWithPositiveThreads() {
    // 1. Override configuration to 4 threads
    ServerConfiguration.set(PropertyKey.MASTER_UFS_PATH_CACHE_THREADS, 4);
    ...
    // 4. Verify AsyncUfsAbsentPathCache is returned
