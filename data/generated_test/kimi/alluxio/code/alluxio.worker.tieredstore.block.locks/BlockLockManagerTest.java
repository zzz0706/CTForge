...
public class BlockLockManagerTest {
    ...
    public void verifyLockReleaseReturnsResourceToPool() throws Exception {
        ...
        ResourcePool<ClientRWLock> spyPool = Mockito.spy(originalPool);
        ...
        // Verify release was called exactly once with the same ClientRWLock instance
