...
public class HBaseMasterPortConfigTest {
  ...
  @Test
  public void testDefaultPortIsUsedWhenNoOverride() {
    ...
    // 3. Test code.
    int actualPort = conf.getInt(HConstants.MASTER_PORT, HConstants.DEFAULT_MASTER_PORT);

    // 4. Code after testing.
    assertEquals("Configuration should contain default master port", expectedPort, actualPort);
  }
}