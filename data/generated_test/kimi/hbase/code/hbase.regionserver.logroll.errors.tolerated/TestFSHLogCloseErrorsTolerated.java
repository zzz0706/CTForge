...
public class TestFSHLogCloseErrorsTolerated {
  ...
  public void testDefaultCloseErrorsToleratedIsLoadedFromConfiguration() throws Exception {
    ...
    int expectedCloseErrorsTolerated = conf.getInt("hbase.regionserver.logroll.errors.tolerated", 2);
    ...
    assertEquals(expectedCloseErrorsTolerated, actualCloseErrorsTolerated);
  }
}