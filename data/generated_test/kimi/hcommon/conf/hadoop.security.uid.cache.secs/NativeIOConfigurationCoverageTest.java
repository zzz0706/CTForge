...
public class NativeIOConfigurationCoverageTest {
    ...
    public void testConfigurationParsingAndUsage() throws Exception {
        ...
        try (FileOutputStream fos = new FileOutputStream(tmp)) {
            ...
            // 3. Test code.
            setCacheTimeout(1000); // 1 second timeout
            ...
            when(System.currentTimeMillis()).thenReturn(500L); // Within timeout
    ...
    public void testZeroTimeoutConfiguration() throws Exception {
        ...
        // 2. Prepare the test conditions.
        setCacheTimeout(0); // Zero timeout means immediate expiry
    ...
    public void testLargeTimeoutConfiguration() throws Exception {
        ...
        // 2. Prepare the test conditions.
        setCacheTimeout(3600 * 1000); // 1 hour in milliseconds
        ...
        try (FileOutputStream fos = new FileOutputStream(tmp)) {
            ...
            PowerMockito.mockStatic(System.class);
            when(System.currentTimeMillis()).thenReturn(0L, 1800 * 1000L); // 30 minutes later
    ...
    public void testCacheRefreshAfterTimeout() throws Exception {
        ...
        try (FileOutputStream fos = new FileOutputStream(tmp)) {
            ...
            when(System.currentTimeMillis())
                ...
                .thenReturn(baseTime + 1000L) // Within timeout
                .thenReturn(baseTime + 3000L); // After timeout
