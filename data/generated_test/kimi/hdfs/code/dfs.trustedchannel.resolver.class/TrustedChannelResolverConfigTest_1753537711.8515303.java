...
public class TrustedChannelResolverConfigTest {
    ...
    public void testCustomTrustedChannelResolverInstantiation() throws Exception {
        ...
        // Mock ReflectionUtils.newInstance to capture the actual class being instantiated
        PowerMockito.spy(ReflectionUtils.class);
        TestTrustedChannelResolver customInstance = new TestTrustedChannelResolver();
        PowerMockito.doReturn(customInstance)
                   .when(ReflectionUtils.class, "newInstance", 
                         any(Class.class), any(Configuration.class));
        ...
        assertSame("Resolver should be our custom instance", customInstance, resolver);
    }
