...
public class TrustedChannelResolverConfigTest {
    ...
    public void testCustomTrustedChannelResolverInstantiation() throws Exception {
        ...
        // Mock ReflectionUtils.newInstance to return our custom instance
        TestTrustedChannelResolver mockResolver = new TestTrustedChannelResolver();
        PowerMockito.mockStatic(ReflectionUtils.class);
        PowerMockito.when(ReflectionUtils.newInstance(
                (Class<?>) any(), any(Configuration.class))).thenReturn(mockResolver);
        ...
        assertSame("Resolver should be our mock instance", mockResolver, resolver);
