...
public class SafeModeInfoConfigTest {
    ...
    public void testSafeModeThresholdPctDefaultValue() {
        ...
        float defaultValue = conf.getFloat(
            ...
            0.999f // This is the documented default
        );
        
        assertEquals("Should use default threshold value", 0.999f, defaultValue, 0.001f);
    }
    ...
    public void testSafeModeThresholdPctFromFile() {
        ...
        float expectedValue = conf.getFloat(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, 0.999f);
    ...
    public void testReplQueueThresholdInheritsFromSafeModeThreshold() {
        ...
        float actualThreshold = conf.getFloat(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, 0.999f);
