...
public class RollingWindowManagerConfigTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testDfsNamenodeTopNumUsersNegativeValueValidation() {
        // 1. You need to use the hdfs 2.8.5 API correctly to obtain configuration values, instead of hardcoding the configuration values.
        // Set dfs.namenode.top.num.users to a negative value using the HDFS API
        conf.setInt(DFSConfigKeys.NNTOP_NUM_USERS_KEY, -1);
        
        // 2. Prepare the test conditions.
        // Attempt to create a RollingWindowManager instance with this configuration
