...
public class TestHBaseRootDirConfiguration {
    ...
    public void testHBaseRootDirConfiguration() {
        ...
        // 1. Check if the hbase.rootdir configuration is set
        assertFalse("hbase.rootdir should not be empty", hbaseRootDir == null || hbaseRootDir.isEmpty());

        // 2. Validate filesystem scheme
        ...
        // 3. Ensure it's not a relative path
