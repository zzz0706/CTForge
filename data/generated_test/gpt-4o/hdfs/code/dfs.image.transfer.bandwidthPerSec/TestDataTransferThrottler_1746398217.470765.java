...
public class TestDataTransferThrottler {
    ...
    public void testThrottlePeriodResetAfterLongInactivity() throws Exception {
        ...
        conf.setLong(DFSConfigKeys.DFS_IMAGE_TRANSFER_RATE_KEY, 1024); // Set bandwidth dynamically
        ...
        assertEquals(1024, throttler.getBandwidth());
        ...
        Canceler canceler = new Canceler(); // Create a canceler for the throttling operation
