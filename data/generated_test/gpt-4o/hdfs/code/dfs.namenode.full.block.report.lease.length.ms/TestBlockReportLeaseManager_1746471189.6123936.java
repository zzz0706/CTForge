...
public class TestBlockReportLeaseManager {
    ...
    public void testPruneExpiredPending_removesExpiredLeases() throws Exception {
        ...
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS, 300000);  // Set custom value for testing
        ...
        // Instantiate the BlockReportLeaseManager using the Configuration object
        ...
        // Create DatanodeDescriptors for the simulated DataNodes
        ...
        // Simulate a delay to cause some leases to expire
        long simulatedCurrentTime = Time.monotonicNow() + leaseLengthMs + 1;

        // Use reflection to access the private method pruneExpiredPending(long)
        ...
        // Invoke pruneExpiredPending with the simulated current time
        pruneExpiredPendingMethod.invoke(leaseManager, simulatedCurrentTime);

        // 3. Verify that expired leases are removed
        // Use reflection to access the private pendingHead field
