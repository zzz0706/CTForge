...
public class BlockReportLeaseManagerTest {
    ...
    /**
     * Test the behavior of requestLease when numPending reaches maxPending.
     */
    @Test
    public void test_requestLease_exceedMaxPending() {
        ...
        // Step 2: Prepare the input conditions for the test
        int maxPending = 1; // Set the maximum allowed pending leases to 1 to simulate constraint
