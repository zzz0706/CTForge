...
public class TestNameNodeResourceMonitor {
    // Test code
    // 1. Use API to get configuration values, avoid hardcoding configuration values.
    ...
    public void test_NameNodeResourceMonitor_withInterruptedSleep() throws Exception {
        // Step 1: Create a Configuration object and set up valid settings.
        ...
        // Step 3: Create and override the NameNodeResourceMonitor instance.
        ...
        // Step 4: Run the NameNodeResourceMonitor logic and verify graceful handling.
        monitor.run();
    }
}