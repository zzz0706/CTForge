...
public class TestRegionFlushLogic {
    ...
    /**
     * Test case: Verify shouldFlushStore method using proper configuration and a store with old edits.
     */
    @Test
    ...
    /**
     * Test case: Verify shouldFlush method when at least one store contains old edits across regions.
     */
    @Test
    public void test_shouldFlush_withOldEditAcrossRegions() throws Exception {
        ...
        long currentTime = EnvironmentEdgeManager.currentTime();
        Mockito.when(oldEditStore.timeOfOldestEdit())
                .thenReturn(currentTime - (flushCheckInterval + 1000));
