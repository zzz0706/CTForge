...
public class TestDataNodeConfiguration {   
    ...
    public void test_startMetricsLogger_with_negative_period() throws IOException {
        ...
        // Set necessary namenode configuration values.
        conf.set(DFSConfigKeys.DFS_NAMENODE_RPC_ADDRESS_KEY, "localhost:9000");

        // DFS_NAMENODE_SERVICERPC_ADDRESS_KEY does not exist in HDFS 2.8.5; it needs to be removed or replaced correctly.
        // SecureDataNodeStarter is only initialized with parameters relevant to DFSConfigKeys.
