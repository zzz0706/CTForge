...
public class SecurityUtilTest {
    ...
    public void test_getByName_throwUnknownHostExceptionForInvalidHostname() {
        ...
        configuration.setInt(CommonConfigurationKeys.HADOOP_SECURITY_DNS_LOG_SLOW_LOOKUPS_THRESHOLD_MS_KEY, 500);
        ...
        // Replace the static hostResolver with the mocked version
        ...
        // Mock hostname resolution and test behavior
    ...
    public void test_getByName_logsSlowLookupsWithCustomThreshold() throws Exception {
        ...
        // Resolve a hostname and ensure it does not throw exceptions
        InetAddress result = SecurityUtil.getByName("slow.hostname");

        // Verify the resolved address is returned
