...
public class TestGroupsConfiguration {
    ...
    @Test
    // Test end-to-end behavior of static mapping propagation.
    public void testStaticMappingPropagationAndUsage() {
        ...
        // Instantiate the Groups class using the configuration, causing static mapping parsing.
        Groups groups = new Groups(conf, timer);

        // Verify group resolution for a user with static mapping.
