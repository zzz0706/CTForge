...
public class TestGroupsConfiguration {
    ...
    // Test Groups constructor initializes background reload thread count correctly,
    // covering the configuration usage.
    @Test
    ...
    // to cover the parseStaticMapping(Configuration conf) logic.
    @Test
    ...
    // Test handling of invalid static user-to-group mapping configuration,
    // ensuring exception is thrown for malformed input.
    @Test
    ...
    // Test default behavior of parseStaticMapping when the configuration key is not set,
    // verifying the default behavior of the map.
    @Test
    ...
    // Test end-to-end behavior of static mapping propagation, ensuring its correctness in group resolution.
    @Test
