...
public class TestTableMapping {
    ...
    // Verify the resolve() method correctly maps nodes to their respective racks using a valid topology file
    @Test
    public void testResolveWithValidTopologyFile() throws Exception {
        // Create and populate a temporary topology file
        ...
        // Verify the rack mappings returned match the topology file
    ...
    // Test the resolve() method when no topology file is configured
    @Test
    public void testResolveWithoutConfiguration() {
        ...
        // Verify fallback to the default rack mappings
        assertNotNull(rackMappings);
    ...
    public void testReloadCachedMappings() throws Exception {
        ...
        // Update topology file with new map entries
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(initialTopologyFile))) {
            writer.write("node1 /rack1\n");
            writer.write("node2 /rack2\n");
        }

        // Reload mappings and verify updated results
    ...
    public void testResolveWithPartialMappings() throws Exception {
        // Create a topology file containing one valid mapping
        ...
        // Verify partial mappings results, fallback for missing mappings
        assertNotNull(rackMappings);
