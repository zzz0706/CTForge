...
public class TestTrashPolicyDefault {
    ...
    public void testEmptierIntervalAdjustmentOnInvalidConfiguration() throws IOException {
        // Step 1: Create a Configuration object with conflicting intervals
        Configuration conf = new Configuration();
        conf.setFloat(CommonConfigurationKeysPublic.FS_TRASH_INTERVAL_KEY, 15.0f); // Trash deletion interval
        conf.setFloat(CommonConfigurationKeysPublic.FS_TRASH_CHECKPOINT_INTERVAL_KEY, 20.0f); // Conflicting checkpoint interval
        ...
        if (emptierRunnable instanceof TrashPolicyDefault.Emptier) {
            ...
            // Validate that the adjusted interval matches the expectation
