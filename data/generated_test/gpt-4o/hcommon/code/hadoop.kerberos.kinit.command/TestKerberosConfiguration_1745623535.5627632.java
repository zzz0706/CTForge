...
public class TestKerberosConfiguration {
    ...
    public void testSpawnAutoRenewalThreadForUserCreds_withKerberosAuthentication() throws InterruptedException {
        ...
        // Inject behavior for required private methods within the UGI object
        doReturn(true).when(mockUGI).isSecurityEnabled();
        doReturn(UserGroupInformation.AuthenticationMethod.KERBEROS).when(mockUGI).getAuthenticationMethod();
