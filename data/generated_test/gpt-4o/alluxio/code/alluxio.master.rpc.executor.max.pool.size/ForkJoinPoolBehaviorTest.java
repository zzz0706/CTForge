...
public class ForkJoinPoolBehaviorTest {
    ...
    public void testForkJoinPoolRunWorkerBehavior() {
        ...
        // Burst workload: Submit excessive tasks exceeding maxPoolSize
        for (int i = 0; i < maxPoolSize * 2; i++) {
            pool.submit(() -> {
                processedTasks.incrementAndGet();
                try {
        ...
        // Assert that the active threads do not exceed maxPoolSize
