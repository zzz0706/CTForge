...
public class LocalFirstAvoidEvictionPolicyTest {
    ...
    public void testEqualsWithSamePolicyInstance() {
        // Step 1: Configure AlluxioProperties with identical reserved size using PropertyKey.
        AlluxioProperties props1 = new AlluxioProperties();
        AlluxioProperties props2 = new AlluxioProperties();

        // Dynamically set the configuration property using the Alluxio 2.1.0 API.
        ...
        // Step 2: Instantiate the LocalFirstAvoidEvictionPolicy classes with configurations.
        ...
        // Step 3: Test the equality of the two policy instances.
        boolean areEqual = policy1.equals(policy2);

        // Step 4: Assert that the two instances are equal.
