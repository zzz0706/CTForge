...
public class WorkerFileBufferSizeConfigTest {
  ...
  public void testWorkerFileBufferSizeConstraints() {
     ...
     * 3. The size must be a positive value greater than 0.
     */
    ...
    try {
      ...
      Assert.assertTrue("Configuration alluxio.worker.file.buffer.size must be greater than 0", bufferSizeInBytes > 0);
