...
public class BlockLockManagerTest {
    ...
    public void test_lockBlock_withWriteLock_successful() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue("The block lock should be held after lockBlock is called.",
            ...
            Assert.assertFalse("The block lock should be released after cleanupSession is called.",
