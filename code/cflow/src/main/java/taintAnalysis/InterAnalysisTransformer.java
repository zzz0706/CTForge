...
public class InterAnalysisTransformer extends SceneTransformer {
    ...
    private FlowModeAnalyzer flowAnalyzer;
    ...
    protected void internalTransform(String phaseName, Map<String, String> options) {
       ...
       // Perform additional flow mode analysis using generated summaries
       flowAnalyzer = new FlowModeAnalyzer(analysis.getMethodSummary());
    ...
    public FlowModeAnalyzer getFlowAnalyzer() {
        return flowAnalyzer;
    }
